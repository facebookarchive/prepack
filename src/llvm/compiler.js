...
import { Module, Function, FunctionType, Type, LinkageTypes, ConstantInt, IRBuilder } from "llvm-node";
...
export function compileSources(
  ...
  let mainFn = Function.create(mainFnType, LinkageTypes.ExternalLinkage, "main", llvmModule);
  ...
  let returnValue = ConstantInt.get(llvmContext, 0);
  let builder = new IRBuilder(mainBlock);
