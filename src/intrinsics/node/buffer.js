...
export default function (realm: Realm): ObjectValue {
  ...
  let setupBufferJS = new NativeFunctionValue(realm, intrinsicName + ".setupBufferJS", "setupBufferJS", 0, (setupContext, setupArgs) => {
  ...
  let createFromString = new NativeFunctionValue(realm, intrinsicName + ".createFromString", "createFromString", 0, (context, args) => {
