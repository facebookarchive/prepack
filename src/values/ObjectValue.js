...
export default class ObjectValue extends ConcreteValue {
  ...
  getSnapshot(options?: { removeProperties: boolean }): AbstractObjectValue {
    try {
      ...
      let buildNode = createResidualBuildNode("SINGLE_ARG");
      let result = AbstractValue.createTemporalFromBuildFunction(this.$Realm, ObjectValue, [template], buildNode, {
        skipInvariant: true,
        isPure: true,
      });
    ...
    if (!this.isSimpleObject()) {
      if (this.$Realm.isInPureScope()) {
        ...
        return AbstractValue.createTemporalFromBuildFunction(
          ...
          Value,
          [Receiver, P],
          createResidualBuildNode("OBJECT_GET_PARTIAL"),
      ...
      if (this.$Realm.isInPureScope()) {
        ...
        this.$Realm.evaluateWithPossibleThrowCompletion(
          () => {
            ...
            generator.emitStatement([Receiver, P, V], createResidualBuildNode("OBJECT_SET_PARTIAL"));
