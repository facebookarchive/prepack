...
import type { BabelBinaryOperator, BabelNodeAssignmentExpression, BabelNodeExpression, BabelNodeStatement } from "babel-types";
...
import { GetValue, PutValue, SetFunctionName, IsAnonymousFunctionDefinition,
   IsIdentifierRef, HasOwnProperty, GetReferencedName, composeNormalCompletions, unbundleNormalCompletion } from "../methods/index.js";
...
export default function (
  ...
  if (AssignmentOperator === "="){
    ...
    if (LeftHandSideExpression.type !== "ObjectLiteral" && LeftHandSideExpression.type !== "ArrayLiteral") {
      ...
      let leftCompletion; [leftCompletion, lref] = unbundleNormalCompletion(lref);
